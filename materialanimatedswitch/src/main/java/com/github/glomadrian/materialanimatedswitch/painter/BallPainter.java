...
public class BallPainter implements SwitchInboxPinnedPainter {
  ...
  public BallPainter(int bgColor, int toBgColor, int padding, int ball_radius, int ball_start_position,
    ...
    init(ball_radius, ball_start_position);
  }

  private void init(int ball_radius, int ball_start_position) {
    paint = new Paint();
    ...
    radius = ball_radius;
    ballStartPositionX = ball_start_position;
